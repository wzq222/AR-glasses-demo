...
- Coverage: 17/17 complete scenes and 75/75 truth objects; proposal recall `1.000`.
...
Four regression tests cover cross-view merging, same-view preservation, large-box
